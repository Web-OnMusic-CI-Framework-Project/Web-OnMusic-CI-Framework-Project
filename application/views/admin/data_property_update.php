                ...
                <div class="card">
                    <div class="card-body">
                        <?php foreach ($alatmusikjasa as $amj) : ?>
                            <form method="POST" action="<?php echo base_url('admin/data_property_music/update_property_action/') . $amj->id_alat_musik_jasa ?>">
                                <div class="form-group">
                                    <label>Nama</label>
                                    <input type="hidden" name="id_alat_musik_jasa" value="<?php echo $amj->id_alat_musik_jasa ?>">
                                    <input type="text" name="Nama" class="form-control" value="<?php echo $amj->Nama ?>">
